...
if (number>22) {
  ...
  desc.innerHTML="Zbuntowane Anioły. Kreatywne i utalentowane";
  ...
  desc.innerHTML="Fundusze europejskie odmieniły Bibliotekę Publiczną Miasta i Gminy Łapy";
  ...
  desc.innerHTML="Miejsce z klimatem do kulinarnych przygód";
  ...
  desc.innerHTML="Komfortowo i bezpiecznie z Sokółki do Dąbrowy Białostockiej";
  ...
  desc.innerHTML="Aktywny wypoczynek w otoczeniu zalewu Czapielówka w Czarnej Białostockiej";
  ...
  desc.innerHTML="Pomoc w walce z pandemią";
  ...
  desc.innerHTML="Hajnówka OdNowa";
  ...
  desc.innerHTML="Technologia produkcji myjni bezdotykowych";
  ...
  desc.innerHTML="Zrewitalizowany plac w Kuleszach Kościelnych";
  ...
  desc.innerHTML="Szpital w Hajnówce zrealizował potężne inwestycje";
  ...
  desc.innerHTML="Implanty chirurgiczne dla zwierząt firmy IWET";
  ...
  desc.innerHTML="Zrównoważona mobilność miejska w Łomży";
